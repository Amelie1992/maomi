package com.xed.financing.wxgzh.service.savings;
...
/**
 * 猫咪储蓄接口
 * @className:com.xed.financing.wxgzh.service.savings.SavingsService
 * @description:
 * @version:v1.0.0 
 * @date:2018年1月8日 下午2:14:43
 * @author:Peng Gang
 */
public interface SavingsService
{
	...
	/**
	 * 添加猫咪储蓄记录
	 * @Description: Integer multiple 倍数
	 * @param savingsBean
	 * @return
	 * @version:v1.0
	 * @author:Peng Gang
