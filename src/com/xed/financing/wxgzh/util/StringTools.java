...
public class StringTools
{
	...
	/**
	 * 
	 * @Description:大于等于0的数字校验，并且保留小数点后两位
	 * @param quota
	 * @return
	 * @version:v1.0
	 * @author:Qian Tao
	 * @date:2017年1月18日 上午10:06:16
	 */
	public static boolean isQuota(String quota)
	{
		Pattern p = Pattern
				.compile("^([1-9][0-9]*(\\.[0-9]{1,2})?|0\\.[1-9][0-9]?|0\\.0[1-9]|[0])$");
		Matcher m = p.matcher(quota);
		return m.matches();
	}
	 ...
	 * @version:v1.0
	 * @author:QT
	 * @date:2017年9月21日 下午4:18:50
	 */
	public static int randomBetween(int a,int b)
	{
		int c= b-a+1;
		int x=(int)(Math.random()*c+a);
		return x;
	}
