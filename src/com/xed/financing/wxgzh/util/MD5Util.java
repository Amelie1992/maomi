...
public class MD5Util
{
    ...
    static {  
        try {  
            ...
            logger.error(MD5Util.class.getName()  
                    + "初始化失败，MessageDigest不支持MD5Util。", nsaex);
        }  
    }  
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, IOException {
       ...
       /* System.out.println("MD5值：" + md5("123456"));
        
        String key = "123qazwsx321";
        String src1 = "这是测试的原始数据了啊啊啊 啊avffafafafaefasfefafaf dfafa";
        String src2 = "这是测试的原始数据了啊啊啊 啊avffafafafaefasfefafbf dfafa";
        
        String value = sign(src1, key);
        System.out.println( verify(value, src2, key) );*/
    }
