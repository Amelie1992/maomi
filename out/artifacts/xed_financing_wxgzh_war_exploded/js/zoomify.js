...
;(function($){
	...
	Zoomify.prototype.zoomIn = function () {
		...
		$(this.$image).next('.deletelable').css('display','none');
		$(this.$image).parents('.box').css('overflow','visible');
	...
	Zoomify.prototype.zoomOut = function () {
		var that = this;
		$(this.$image).next('.deletelable').css('display','');
		$(this.$image).parents('.box').css('overflow','hidden');
		this._zooming = true;
