...
/**
 * 
 * @className:com.fzjt.util.RandomValidateCode
 * @description:
 * @version:v1.0.0
 * @date:2016-1-3 下午4:25:11
 * @author:LuYingchun
 */
public class RandomValidateCode
{
	...
	private int width = 76;// 图片宽
	private int height = 35;// 图片高
	private int lineSize = 35;// 干扰线数量
	...
	public void getRandcode(HttpServletRequest request, HttpServletResponse response)
	{
		...
		// 将随机生成的验证码存入session中
		if (session.getAttribute(RANDOMCODEKEY) != null)
		{
