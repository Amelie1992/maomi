 ...
 *
 */
package com.xed.financing.wxgzh.service.subjectpic;
...
/**
 * 
 * @className:com.xed.financing.wxgzh.service.subjectpic.SubjectPicService
 * @description:
 * @version:v1.0.0 
 * @date:2017年10月12日 上午9:12:26
 * @author:Elias Zheng
 */
public interface SubjectPicService
{
	
	/**
	 * 查询全部图片(传subjectId查询对应,不传查询全部)
	 * @Description:
	 * @param subjectPicBean
	 * @return
	 * @throws SQLException
	 * @version:v1.0
	 * @author:Elias Zheng
	 * @date:2017年10月12日 上午9:04:39
	 */
