...
/**
 * 
 * @className:com.xed.financing.manager.web.util.MobileMessageCheck
 * @description:校验验证码工具类
 * @version:v1.0.0 
 * @date:2017年3月1日 下午4:04:05
 * @author:WangJun
 */
public class MobileMessageCheck
{
    ...
    private static final String APP_KEY="f890041787ee78309f3123b61e5b08ff";//账号
    private static final String APP_SECRET="73a0e4f1f0f3";//密钥
