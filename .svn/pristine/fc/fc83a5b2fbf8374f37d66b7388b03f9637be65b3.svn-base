var footPlay = document.getElementById('footaudio');

var bgmPlay = document.getElementById('bgmaudio');
...
function scs2(e, t, n) {
	...
	for(scx = 0; scx < t; scx++) n = Math.floor(e.substr(9 - scx - 1, 1)), spt2(130 + n, 216 - 21 * scx, 118)
}
...
function init() {
	...
	bgmPlay.play();
	gldt = 0;
	e = navigator.language; - 1 < document.URL.indexOf("page") ? (e = ["title_3d_nolink.jpg", "bg.jpg", "end_3d_nolink.jpg", "en.png"], canvas.style.backgroundImage = "url(images/title_3d_nolink.jpg)", shms1 = "Browser game[Look Bear,Run!] SCORE=", shms2 = "Browser game[Look Bear,Run!]", shms3 = "Why don't you get useful tips by sharing this game to your friends?", shms4 = "Why don't you get useful items by sharing this game to your friends?") : -1 < e.indexOf("ja") ? (e = ["title_3d.jpg", "bg.jpg", "end_3d.jpg", "cs_3d.png"], canvas.style.backgroundImage = "url(images/ber/title_3d.jpg)", shms1 = "??????V???u???E?U?Q?[???u????I????????v SCORE=", shms2 = "??????V???u???E?U?Q?[???u????I????????v", shms3 = "?F?B?????Q?[?????V?F?A???¨¡A????TIPS???Q?b?g???•?I", shms4 = "?F?B?????Q?[?????V?F?A???¨¡A?A?C?e?????Q?b?g???•?I") : (e = ["titl.jpg", "bg.jpg", "end.jpg", "en.png"], canvas.style.backgroundImage = "url(images/ber/titl.jpg)", shms1 = "Browser game[Look Bear,Run!] SCORE=", shms2 = "Browser game[Look Bear,Run!]", shms3 = "Why don't you get useful tips by sharing this game to your friends?", shms4 = "Why don't you get useful items by sharing this game to your friends?");
	img0 = new Image;
	img0.src = "images/ber/" + e[0];
	img0.onload = function() {
		gsts()
	};
	img1 = new Image;
	img1.src = "images/ber/" + e[1];
	img1.onload = function() {
		gsts()
	};
	img2 = new Image;
	img2.src = "images/ber/" + e[2];
	img2.onload = function() {
		gsts()
	};
	img7 = new Image;
	img7.src = "images/ber/" + e[3];
...
function Press(e) {
	...
	switch(s) {
		...
		case 2:
			n = e.y / wdpr | 0;
			175 < t && 365 < n ? window.location.href = HOME_PATH : 35 < t && 180 < n && t < 155 && n < 225 ? (scr = 0, stini(), s = 1) : 168 < t && 180 < n && t < 286 && n < 225 && setTimeout(function() {
				show_share()
			}, 500)
	}
	e = e.y / wdpr;
...
function lp() {
	...
	if(0 == ogm) {
		stgbg += 1 + (0 < fvr);
		4 < stgbg && (stgbg -= 5);
		ctx.drawImage(img1, 320 * stgbg, 0, 320, 416, 0, 0, 320, 416);
		var r = [];
		...
		if(uct > c && (uct = 0, 0 < usi.length))
			if(0 < spdr) iint(spdr + 26, 417, 2, 12), spdr = -2;
			else switch(c = Math.floor(260 * Math.random()) + 30, i = 0, e) {
				case 0:
				case 1:
					iint(c, 417, slv, r);
					break;
		...
		gtm++; - 1 > mes && 196 > ty[1] ? dgt++ : dgt = 0; - 1 > mes && 80 < dgt && 0 == fvr && 300 < scr && 0 == ogm && (bcv2.drawImage(ctx.canvas, 0, 0, 320, 416, 0, 0, 320, 416), ogm = 1, scr |= 0, 999999 == bstscr && (e = new Date, e.setDate(e.getDate() + 730), document.cookie = "rvs_3d_run=" + scr + "endcksv; expires=" + e.toGMTString(), bstscr = scr))
	} else ogm++, 31 > ogm ? (ctx.drawImage(bcv2.canvas, 0, 0, 320, 416, 0, 0, 320, 416), f = ogm / 30, 1 < f && (f = 1), ctx.globalAlpha = f, ctx.fillStyle = "#000", ctx.fillRect(0, 0, 320, 416), ctx.globalAlpha = 1, spt2(126, bex[ef], bey[ef])) : 50 > ogm ? (ctx.globalAlpha = .5, f = 108 - gmovf, h = 100 + 2 * gmovf, gmovf += gmovc, gmovc += 3, ctx.drawImage(img7, 735, 0, 100, 100, f, f, h, h)) : (60 > ogm ? (f = (ogm - 50) / 30, 1 < f && (f = 1)) : (0 == gmovcl && (gmovcl = 1), ctx.drawImage(img2, 0, 0, 320, 416, 0, 0, 320, 416), scs2(99, String(scr).length, scr), bstscr == scr && spt2(150, 76, 103), 1 == gtips && spt2(152, 79, 309), 1 < gmsts && (spt2(152, 188, 320), 2 < gmsts && spt2(152, 276, 320)), f = 1 - (ogm - 60) / 30, 0 > f && (f = 0, s = 2, updateShareScore(scr))), ctx.globalAlpha = f, ctx.fillStyle = "#FFF", ctx.fillRect(0, 0, 320, 416), ctx.globalAlpha = 1);
